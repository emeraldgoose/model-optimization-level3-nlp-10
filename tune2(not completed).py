...
def search_model(trial: optuna.trial.Trial) -> List[Any]:
    ...
    model = []
    n_stride = 0
    MAX_NUM_STRIDE = config_dic['max_num_stride']
    UPPER_STRIDE = config_dic["upper_stride"]

    activation_candidates = config_dic["activation"]
...
# main -> tune("gpu", "storage") -> objective ("trial", "device") -> get_best_trial_with_condition(study)
